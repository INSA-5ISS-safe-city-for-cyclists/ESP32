...
void BLE::send_data(int distance, int object_speed){

    DynamicJsonDocument doc(1024);
    doc["timestamp"]=millis();
    doc["date"]="2/12/2021";
    doc["distance"]= distance;
    doc["object_speed"]=object_speed;
    doc["latitude"]=50;
    doc["longitude"]=95;
